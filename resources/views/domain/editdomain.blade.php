...
<div class="card">
    <div class="card-body">
      <h4 class="card-title">Edit Domain</h4>
        <form class="forms-sample" action="/subdomain/simpanedit/{{$Show->id_domain}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$Show->link}}" class="form-control" id="exampleInputName1" placeholder="link" name="link">
                    @error('link')
                      <p class="text-danger">{{$message}}</p>
                    @enderror
                  </div>
        ...
        <div class="row mb-3 d-flex align-items-center">
            <div class="col-sm-6">
                <img src="{{asset('domain').'/'.$Show->foto}}" class="img-fluid">
            </div>
            <div class="col-sm-6">
                <div class="form-group">
